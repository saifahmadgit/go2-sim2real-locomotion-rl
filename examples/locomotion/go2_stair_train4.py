...
def get_cfgs():
    ...
    terrain_cfg = {
        ...
        # Stair geometry (realistic residential dimensions)
        "step_depth_m": 0.25,           # 25cm tread depth (realistic residential, was 30cm)
        ...
        "step_height_max": 0.20,        # Row 12: 20cm (max residential riser height)
...
def main():
    ...
    parser.add_argument("-e", "--exp_name", type=str, default="go2-stairs-v4")
    ...
    # ================================================================
    print("\n" + "=" * 70)
    print("  TRAINING CONFIG — STAIR CLIMBING v4 (harder stairs + pitch-tolerant)")
    print("=" * 70)
    ...
    if tc.get("enabled"):
        ...
        print(f"    Tread depth          : {tc['step_depth_m']*100:.0f}cm (realistic residential)")
